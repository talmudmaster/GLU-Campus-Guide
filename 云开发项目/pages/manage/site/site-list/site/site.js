...
Page({
    ...
    bindchange(e) {
        ...
        console.log('this.data.category_list', this.data.category_list);
        console.log('this.category_name_list', this.category_name_list);
    ...
    getPoint() {
        wx.navigateTo({
            url: './choose-point/choose-point?lo=' + this.data.lo + '&la=' + this.data.la,
        })
    },
