...
Page({
    ...
    data: {
        ...
        black_location: utils.black_location,
        ...
        // polylines: [{
        //     utils: utils.school_outline,
        //     width: 5,
        //     color:'#FF0000',
        //     // dottedLine:true,
        //     arrowLine: true,
        //     // borderWidth: 1,
        //     // arrowIconPath:"../../images/arrowIcon.png"
        // }]
    },
    ...
    map() {
        ...
        this.mapCtx.addGroundOverlay({
            ...
            bounds: {
                southwest: { //西南角
                    // latitude: 25.087579,
                    // longitude: 110.273221,
                    latitude: 25.088910,
                    longitude: 110.273880,
                },
                northeast: { //东北角
                    // latitude: 25.100458,
                    // longitude: 110.282613,
                    latitude: 25.098995,
    ...
    routePlan: function () {
        ...
        if (this.data.category_end != 0) {
            ...
            // console.log(this.data.sitedata[this.data.category_end-1].list[this.data.site_end-1])
